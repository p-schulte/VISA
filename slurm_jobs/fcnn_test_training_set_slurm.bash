...
#SBATCH --output=/work/rleap1/paul.schulte/logs/fcnn_test/fcnn_test_log.txt  # Output log file
...
python -u fasterRCNN/test_net.py --dataset blocks_voc --net res101 --cuda --use_training_set
