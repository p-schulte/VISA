...
import yaml
from yaml import FullLoader  # Import FullLoader explicitly
...
__C.TRAIN.MAX_SIZE = 480

# Trim size for input images to create minibatch
__C.TRAIN.TRIM_HEIGHT = 480
__C.TRAIN.TRIM_WIDTH = 480
...
## threshold for keeping predictions in dsg-detr
...
# Data directory
__C.DATA_DIR = 'fasterRCNN/data/scene_understanding/'#osp.abspath(osp.join(__C.ROOT_DIR, 'data'))
...
def cfg_from_file(filename):
  ...
  import yaml
  with open("fasterRCNN/"+filename, 'r') as f:
    yaml_cfg = edict(yaml.load(f, Loader=FullLoader))  # Specify Loader
