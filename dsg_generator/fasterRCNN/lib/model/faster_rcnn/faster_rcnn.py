...
class _fasterRCNN(nn.Module):
    """ faster RCNN """
    def __init__(self, classes, class_agnostic, use_for_dsg=False):
        super(_fasterRCNN, self).__init__()
        self.use_for_dsg = use_for_dsg
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        # THE TWO LINES BELOW DETERMINE WHETHER TRAINING OR DYNAMIC SCENE GRAPH DETECTION
        if self.use_for_dsg:
