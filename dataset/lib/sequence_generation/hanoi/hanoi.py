...
from lib.rendering.hanoi import hanoi_render
...
def register_blocks_env(initialize_randomly=False, num_discs=5, num_pegs=3):
    ...
    ENV_NAME = "MyCustomHanoiEnv-v0"
    PDDL_DOMAIN_DIR = "pddl_files/hanoi"
    PDDL_PROBLEMS_DIR = "pddl_files/hanoi/problems"

    if initialize_randomly:
        # Generate a random PDDL problem
        PDDL_PROBLEMS_DIR = "pddl_files/hanoi/random_problems"
        import lib.sequence_generation.hanoi.random_state as random_state
        import os
    ...
    register(
        ...
        kwargs={"domain_file": f"{PDDL_DOMAIN_DIR}/domain.pddl", "problem_dir": f"{PDDL_PROBLEMS_DIR}/", 'render' : hanoi_render.render},
    )
...
def create_fresh_env(config, test_set=False):
    ...
    # Randomize colors
    from lib.rendering.hanoi import hanoi_render
    hanoi_render._block_name_to_color = {}
